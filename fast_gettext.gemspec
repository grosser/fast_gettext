...
Gem::Specification.new do |s|
  ...
  s.files = ["README.markdown", "VERSION.yml", "lib/fast_gettext", "lib/fast_gettext.rb", "lib/fast_gettext/mo_file.rb", "lib/fast_gettext/storage.rb", "lib/fast_gettext/translation.rb", "lib/fast_gettext/translation_repository", "lib/fast_gettext/translation_repository.rb", "lib/fast_gettext/translation_repository/base.rb", "lib/fast_gettext/translation_repository/mo.rb", "lib/fast_gettext/translation_repository/po.rb", "spec/aa_unconfigued_spec.rb", "spec/fast_gettext", "spec/fast_gettext/mo_file_spec.rb", "spec/fast_gettext/storage_spec.rb", "spec/fast_gettext/translation_repository", "spec/fast_gettext/translation_repository/base_spec.rb", "spec/fast_gettext/translation_repository/mo_spec.rb", "spec/fast_gettext/translation_repository/po_spec.rb", "spec/fast_gettext/translation_spec.rb", "spec/fast_gettext_spec.rb", "spec/locale", "spec/locale/de", "spec/locale/de/LC_MESSAGES", "spec/locale/de/LC_MESSAGES/test.mo", "spec/locale/de/test.po", "spec/locale/en", "spec/locale/en/LC_MESSAGES", "spec/locale/en/LC_MESSAGES/test.mo", "spec/locale/en/test.po", "spec/spec_helper.rb", "spec/vendor", "spec/vendor/fake_load_path", "spec/vendor/fake_load_path/iconv.rb", "spec/vendor/iconv_spec.rb", "spec/vendor/string_spec.rb", "vendor/README.rdoc", "vendor/empty.mo", "vendor/iconv.rb", "vendor/mofile.rb", "vendor/poparser.rb", "vendor/string.rb"]
  s.has_rdoc = true
